...
})(window, document, 'script', window.location.hostname != 'cd.lianjia.com' ? '//www.google-analytics.com/analytics.js' : ((window.path || ['http://static1.ljcdn.com/'])[0].split('com/')[0] + 'com/dep/ga_local/analytics.js'), 'ga');
    ...
    switch (hostname) {
        ...
        default :
            if (hostname.match(/^(us|ca|uk|au|nz|ja|fr)\.lianjia\.com/g) !== null) {
                ...
                pid = 'lianjiamweb';
            } else if (hostname.match(/^(\S+\.)*(bj|sh|gz|sz|tj|cd|nj|hz|qd|dl|xm|wh|cq|cs|xa|jn|sjz|yt)\.lianjia\.com/g) !== null) {
                pid = 'lianjiaweb';
            }
            break;
    }
