        ...
        function showError(fun, name, data) {
            ...
            switch (fun) {
              ...
              case "minLength":
                ...
                break;
              case "passwordRule":
                text = name + "要求在6-18位之间，建议字母、数字和符号两种及以上组合";
                break;
            }
...
define("user/verifyImg", function(require) {
    ...
    return function(option) {
        ...
        var result = new BaseLayer({
            html: "<p>" + '<input type="text" validate="notNull,length" validatedata="length=5" validatename="验证码" placeholder="请输入右侧图片内容"><img src="' + opt.url + '">' + "</p>" + '<button class="actValidate">提交</button>' + '<a href="#" class="actClose"></a>',
            style: {
                position: "fixed"
            },
            esc: "destroy",
                ...
                if (!success) {
                    ...
                    switch (data.errorCode) {
                      ...
                      case 3:
                        ...
                        break;
                      case 4:
                        msg = "密码要求在6-18位之间，建议字母、数字和符号两种及以上组合";
