...
<link rel="stylesheet" href="{{ URL::asset('register/common.css') }}">
<link rel="stylesheet" href="{{ URL::asset('register/login.css') }}">
<!--[if lt IE 9]>
...
<body>
 <header class="lianjia-header"><div class="nav-wrap"><ul class="nav-lst">
    <li><a class="home-a  first" href="{{ URL('/') }}"><span>首页</span></a></li>
    <li><a rel="nofollow"  class="home-a  " href="http://www.zufangzi.com/"><span>丁丁租房</span></a></li>
</ul>
<div class="login-panel typeUserInfo"><div class="typeShowUser"><span class="welcome">您好，欢迎来到链家！请<a href="{{ URL('register') }}"><span class="log">注册</span></a> 或 <a href="{{ URL('login') }}" class="btn-login bounceIn "><span class="reg">登录</span></a></span></div></div></div></header>

	<div class="user-login">
		<div class="back">
			<a href="{{ URL('/') }}" class="fl">返回链家网首页</a>
			<div class="fr">
				已有链家账号？<a href="{{ URL('login') }}" id="actResetUrl">马上登录</a>
			</div>
		</div>
		<div class="wrapper">
			<div class="bg-image">
				<img src="{{ URL::asset('register/login-bg.jpg') }}">
			</div>
			<div class="logo"><img src="{{ URL::asset('register/login-logo.png') }}"></div>
			<div class="reset-pwd registerred">
				<form action="{{ URL('register_do') }}" method="post" id="registerForm">
		...
		<script src="{{ URL::asset('register/fe.js') }}"></script>
		<script src="{{ URL::asset('register/register.js') }}"></script>
